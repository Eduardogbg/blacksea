...
library BokkyPooBahsRedBlackTreeLibrary {
    ...
    function max(Tree storage self) internal returns (uint256) {
        return treeMaximum(self, self.root);
    }

    function min(Tree storage self) internal returns (uint256) {
        return treeMinimum(self, self.root);
    }
}
// ----------------------------------------------------------------------------
